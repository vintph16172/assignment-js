        ...
        <nav class="bg-gray-800" id="admin-header">
                ...
                <div class="hidden md:block">
                    ...
                    <div class="ml-3 relative">
                        <div>
                            ...
                            <img class="h-8 w-8 rounded-full" src="${localStorage.getItem('user') ? JSON.parse(localStorage.getItem("user")).avatar: "" }" alt="">
                            </button>
                        </div>
            ...
            <div class="md:hidden" id="mobile-menu">
                ...
                <div class="pt-4 pb-3 border-t border-gray-700">
                    ...
                    <div class="flex-shrink-0">
                        <img class="h-10 w-10 rounded-full" src="${localStorage.getItem('user') ? JSON.parse(localStorage.getItem("user")).avatar: "" }" alt="">
                    </div>
                    <div class="ml-3">
